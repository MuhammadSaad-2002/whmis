<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .meta { font-size: 9px; color: #555; line-height: 1.5; }
    table.items { width: 100%; border-collapse: collapse; margin-top: 8px; }
    table.items th { background: #f0f0f0; border: 1px solid #ccc; padding: 4px 5px; font-size: 8.5px; text-transform: uppercase; text-align: left; }
    table.items td { border: 1px solid #ddd; padding: 4px 5px; }
    .num { text-align: right; font-variant-numeric: tabular-nums; }
    .totals { width: 260px; margin-top: 10px; margin-left: auto; border-collapse: collapse; }
    .totals td { padding: 3px 6px; }
    .totals .grand { border-top: 1.5px solid #1a1a1a; font-weight: bold; font-size: 12px; }
    .muted { color: #777; }
